# The secure-proxy authentication flow with JWT generated by the secure-proxy REST API
...
![Diagram](authentication_jwt.svg)
...
To obtain the proxy token, SP sends an "Info request" to know if the user is
subscribed. If they are, the proxy token is generated by the SPS.
